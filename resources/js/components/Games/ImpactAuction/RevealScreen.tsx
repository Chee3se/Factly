...
import { AuctionItem, ItemWinner, AuctionGameState } from "@/types/impactauction";
...
export function RevealScreen({ item, winner, gameState, onContinue, isGameOwner }: Props) {
  ...
  const sortedBids = [...winner.allBids].sort((a, b) => b.bidAmount - a.bidAmount);

  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 p-4 md:p-8 flex items-center justify-center">
      <div className="max-w-5xl w-full">
        ...
        <div className="text-center mb-8 animate-fade-in">
          <div className="inline-block mb-4">
            <div className="relative">
              ...
              <h1 className="relative text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-200 via-yellow-400 to-orange-400">
                SOLD!
              </h1>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 shadow-2xl p-8">
            <span className={`inline-block px-4 py-2 rounded-full text-white font-semibold text-sm bg-gradient-to-r ${getCategoryColor(item.category)} mb-4`}>
            ...
            {/* Winner Info */}
            <div className="bg-gradient-to-r from-yellow-500/20 to-orange-500/20 rounded-lg p-6 border-2 border-yellow-400">
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className={`font-semibold ${isWinner ? 'text-yellow-400' : 'text-white'}`}>
                            {bid.userName}
                            {isWinner && (
                      ...
                      <div className={`text-2xl font-bold ${isWinner ? 'text-yellow-400' : 'text-white/80'}`}>
                        {bid.bidAmount}
                      </div>
                    </div>
                  );
        ...
        <div className="mt-8 text-center">
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 shadow-2xl p-6 inline-block">
